...
#pragma target 3.0
	...
	void surf(Input IN, inout SurfaceOutputStandard o) {
		...
		fixed4 e = 0;
		e.xyz = lerp(e.xyz, _SplatColor1.xyz, splatMask.x);
		e.xyz = lerp(e.xyz, _SplatColor2.xyz, splatMask.y);
		e.xyz = lerp(e.xyz, _SplatColor3.xyz, splatMask.z);
		e.xyz = lerp(e.xyz, _SplatColor4.xyz, splatMask.w);
		e *= _Emission;
