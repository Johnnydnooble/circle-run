...
public class HighlightNearestFace : MonoBehaviour
{
    ...
    // ProBuilder mesh component // Сетка ProBuilder
    //    private pb_Object target;
    private ProBuilderMesh target;
    // The nearest face to this sphere. // Ближайшее лицо к этой сфере.
    //    private pb_Face nearest = null;
    private Face nearest = null;
    private PivotLocation pl = 0;

    void Start()
    {
 //       pl;
        // Generate a 50x50 plane with 25 subdivisions, facing up, with no smoothing applied.
        target = ShapeGenerator.GeneratePlane(pl, travel, travel, 25, 25, Axis.Up);
...
//        int faceCount = target.faces.Length;
        ...
        // Apply the stored vertex color array to the Unity mesh. // Применяем сохраненный массив цветов вершин к сетке Unity.
